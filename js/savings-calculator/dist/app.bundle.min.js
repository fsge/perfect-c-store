...
var _StepIndicator = __webpack_require__(26);

var _StepIndicator2 = _interopRequireDefault(_StepIndicator);

var _RangeInput = __webpack_require__(27);
...
var Root = function (_React$Component) {
  ...
  function Root(props) {
    ...
    _this.state.totalSavings = _this.getTotalSavings(_this.state);
    return _this;
  }
  ...
  _createClass(Root, [{
    ...
    value: function handleInputChange(key, value) {
      var state = _extends({}, this.state, _defineProperty({}, key, value));
    ...
    key: 'getTotalSavings',
    value: function getTotalSavings() {
    ...
    value: function skipStep() {
      ...
      var currentStep = stepConfig[this.state.step - 1];

      this.setState((_setState = {}, _defineProperty(_setState, currentStep.stateVar, 0), _defineProperty(_setState, 'step', this.state.step + 1), _setState));
    }
  }, {
    ...
    value: function componentDidUpdate() {
      ...
      Object.keys(inputMapping).forEach(function (k) {
        document.querySelector('input[name="' + inputMapping[k] + '"]').value = _this2.state[k];
      });
    }
  }, {
    key: 'render',
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        currentStep ? _react2.default.createElement(
          ...
          _react2.default.createElement(_StepIndicator2.default, {
            steps: stepConfig,
            current: this.state.step }),
          _react2.default.createElement(
            'div',
            { className: 'img-wrapper' },
            _react2.default.createElement('img', { src: '/img/savings-calculator/' + currentStep.icon + '.svg' })
          ),
          _react2.default.createElement(
            'p',
            null,
          ...
          _react2.default.createElement(
            'p',
            null,
            'How many drink coolers do you have?'
          ),
          _react2.default.createElement(
            'div',
            ...
            _react2.default.createElement('input', {
              ...
              onChange: function onChange(e) {
                return _this3.handleInputChange('name', e.target.value);
              } }),
            _react2.default.createElement('input', {
              type: 'email',
              placeholder: 'Your Email',
              onChange: function onChange(e) {
                return _this3.handleInputChange('email', e.target.value);
              } }),
            _react2.default.createElement(
              'button',
              {
...
var StepIndicator = function StepIndicator(_ref) {
  ...
  return _react2.default.createElement(
    ...
    steps.map(function (s, i) {
      return _react2.default.createElement(
        'div',
        { key: i, className: 'step ' + (current == i + 1 ? 'active' : '') },
        i + 1
      );
    })
  );
...
var RangeInput = function (_React$Component) {
  ...
  function RangeInput(props) {
    ...
    return _possibleConstructorReturn(this, (RangeInput.__proto__ || Object.getPrototypeOf(RangeInput)).call(this, props));
  }
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'div',
            { className: 'value-bounds' },
            _react2.default.createElement(
              'span',
              { className: 'value', style: { left: this.getPosition() } },
              this.props.value
            )
          ),
          _react2.default.createElement('input', {
            ...
            onChange: function onChange(e) {
              return _this2.props.onChange(_this2.props.name, e.target.value);
            } })
        ),
        _react2.default.createElement(
          'span',
